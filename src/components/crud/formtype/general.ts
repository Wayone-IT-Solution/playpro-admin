...
export const blogField: FormField[] = [
  {
    ...
    required: true,
    placeholder: "Enter a catchy blog title in English",
  },
  {
    type: "text",
    name: "title.ar",
    label: "عنوان المدونة (Arabic)",
    required: false,
    placeholder: "أدخل عنوان المدونة باللغة العربية",
  },
  {
    options: [],
    required: true,
  ...
  },
  {
    ...
    placeholder: "Write a short summary in English (max 250 characters)",
  },
  {
    rows: 1,
    required: false,
    ...
    label: "الوصف القصير (Arabic)",
    placeholder: "اكتب ملخصًا قصيرًا باللغة العربية (بحد أقصى 250 حرفًا)",
  },
  {
    rows: 1,
    required: true,
    widthFull: true,
    name: "description.en",
    label: "Full Blog Content (English)",
    type: "richTextEditor",
  ...
  },
  {
    ...
    widthFull: true,
    name: "description.ar",
    label: "المحتوى الكامل للمدونة (Arabic)",
    type: "richTextEditor",
    placeholder: "اكتب محتوى المدونة هنا باللغة العربية...",
  },
  {
    type: "file",
    required: true,
...
export const categoryField: FormField[] = [
  {
    ...
    placeholder: "Enter the category name in English (e.g., Football, Lifestyle)",
  },
  {
    type: "text",
    name: "name.ar",
    ...
    placeholder: "Enter the category name in Arabic",
  },
  {
    type: "choose",
    name: "isActive",
  ...
  //   type: "textarea",
  //   maxLength: 200,
  //   placeholder: "Provide a short description of the category in English",
  // },
  // {
  //   rows: 1,
  //   widthFull: true,
  //   name: "description.ar",
  //   label: "Category Description (Arabic)",
  //   type: "textarea",
  //   maxLength: 200,
  //   placeholder: "Provide a short description of the category in Arabic",
  // },
];
